...
namespace wlib::vecmath
{
	...
	/// Mathematical vector of floating point elements
	...
	/// Calculate dot product of `lhs` and `rhs`
	...
	/// Calculate euclidean distance between `lhs` and `rhs`
	...
	/// Normalize `vec` using fast and inaccurate sqrt approximation
	...
	/// Calculate reflection direction <br>
	/// `surfaceNormal` should be normalized
	...
	/// Calculate refraction vector <br>
	/// `surfaceNormal` and `incident` should be normalized
	...
	/// Calculate cross product of `lhs` and `rhs`
